...
max_seq_length = 150#512...The maximum total input sequence length after tokenization. Sequences longer than this will be truncated, sequences shorter will be padded.
split_num = 10
...
per_gpu_train_batch_size = 1#8#Batch size per GPU/CPU for training.
per_gpu_eval_batch_size = 64#8#Batch size per GPU/CPU for evaluation.
